	...
	<div class="metabox-prefs">
		<div class="wrap about-wrap" style="position:relative;">
			<div style="float:right;">
				<a href="https://developers.google.com/web/fundamentals/performance/optimizing-content-efficiency/javascript-startup-optimization/" target="_blank" rel="noopener"><img src="<?php print $view->module->dir_url(); ?>admin/images/js-logo.svg" alt="Javascript Optimization" width="180" height="180" border="0" style="float:right;"></a>
			</div>
			...
			<p class="about-text" style="min-height:inherit;">This plugin is a toolkit for advanced Javascript code and delivery optimization for WordPress.</p>
			...
			<p class="about-text">If you are interested in HTML, CSS or Service Worker optimization, check out the <a href="<?php print esc_url(add_query_arg(array('s' => 'o10n', 'tab' => 'search', 'type' => 'author'), admin_url('plugin-install.php'))); ?>">other plugins</a> that are designed to cooperate with this plugin.</p>
